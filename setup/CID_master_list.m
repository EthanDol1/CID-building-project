% masterList has the node number, the node name, the pattern, the corresponding diary
% pattern, the full day self loop probability and avg number of entries, and the self loops
% and avg number of entries for each time period.
