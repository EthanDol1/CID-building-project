...
% Full day analysis - these data are used to inform the time independent
% model, which is not the full model. The time independent model is not
% discussed in the BUILD paper. This same analysis is done on each time
% period below.
